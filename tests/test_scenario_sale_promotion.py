...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        activate_modules(['sale_discount', 'sale_promotion'])
        ...
        sale_line.quantity = 10
        sale.save()
        self.assertEqual(sale.untaxed_amount, Decimal('500.00'))
        sale.click('quote')
        self.assertEqual(sale.untaxed_amount, Decimal('470.00'))
        ...
        sale_line.quantity = 10
        sale.save()
        self.assertEqual(sale.untaxed_amount, Decimal('360.00'))
        sale.click('quote')
        self.assertEqual(sale.untaxed_amount, Decimal('360.00'))
